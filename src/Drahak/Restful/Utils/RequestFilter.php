...
class RequestFilter
{
	...
	{
		$offset = empty($this->request->getQuery('offset')) ? $offset : $this->request->getQuery('offset');
		$limit = empty($this->request->getQuery('limit')) ? $limit : $this->request->getQuery('limit');
